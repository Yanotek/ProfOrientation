...
namespace ProfTests.Data
{
    ...
    public static class Input
    {
        public static Methodic PrimaryMethodic()
        {
            ...
            return new Methodic()
            {
                Evaluation = new TestControl(),
                Name = "Тест «Зачем нужен труд?»",
                Description = @"Дорогой друг! Внимательно прочитай вопросы, связанные с твоим отношением к труду и выбери один вариант ответа, нажав на него мышкой. 
Здесь нет правильных или неправильных ответов, правилен каждый правдивый ответ. Иногда люди стремятся отвечать так, как, по их мнению, они должны себя вести. Но сейчас нас интересует то, как ты ведешь себя в действительности.",
                Questions = questions,
                CalcResult = (methodic) =>
                {
                    int scores = 0;
                    ...
                    Dictionary<int, Tuple<string, string>> levels = new Dictionary<int, Tuple<string, string>>()
                    {
                        [12] = Tuple.Create("Высокий уровень сформированности представлений о мире профессий и ценностного отношения к труду", "Это означает, что ты обладаешь обширными знаниями о мире профессий, понимаешь значение труда в жизни человека.   У тебя есть самостоятельное и активное стремление изучать мир профессий, желание иметь в будущем социально-значимую профессию.  Ты можешь самостоятельно преодолевать трудности, возникающие при выполнении поручений, помогаешь сверстникам, активно участвуешь в коллективной деятельности, предлагаешь и реализовываешь интересные творческие идеи. В учебной и трудовой деятельности ты дисциплинирован и ответственен."),
                        [8] = Tuple.Create("Средний уровень сформированности представлений о мире профессий и ценностного отношения к труду", "Это означает, что у тебя есть знания о профессиях ближайшего производственного окружения, но ты немного затрудняешься при объяснении значения труда в жизни человека. Ты знаешь отдельные профессионально-значимых качеств той или иной профессии, эпизодически стремишься изучать мир профессий. В будущем ты хочешь иметь престижную профессию. Ты проявляешь стремление к социально-ценностной деятельности при наличии примера со стороны сверстников или взрослых,  участвуешь в коллективной деятельности на «вторых» ролях.  В учебной и трудовой деятельности ты дисциплинирован и ответственен только при наличии контроля взрослых или товарищей."),
                        [0] = Tuple.Create("Низкий уровень сформированности представлений о мире профессий и ценностного отношения к труду", "Это означает, что ты обладаешь знаниями об отдельных профессиях, но не понимаешь значения труда в жизни человека и затрудняешься назвать качества личности, необходимые в труде.  К сожалению, у тебя слабо проявляется стремление изучать мир профессий. Иногда тебе не хватает силы воли, что преодолеть трудности, возникшие при выполнении трудовых поручений. Не нужно избегать участия в коллективной деятельности, ведь вместе всегда веселее и легче!  ")
                    };

                    var res = levels.First(x => scores >= x.Key).Value;

                    methodic.TestResult = new List<TestResult>
                    {
                        new TestResult(res.Item1, res.Item2)
                    };
                }
            };
        }
        ...
        public static Methodic PrimaryMethodicSecond()
        {
            List<Question> questions = new List<Question>
            {
                ...
                CreateLikeAnswer("Работать руками", "Исполнительский класс"),
                CreateLikeAnswer("Выполнять решения", "Исполнительский класс"),
                CreateLikeAnswer("Воспроизводить имеющиеся образцы, размножать и копировать", "Исполнительский класс"),
                CreateLikeAnswer("Получать конкретный практический результат", "Исполнительский класс"),
                CreateLikeAnswer("Воплощать идеи в жизнь", "Исполнительский класс"),

                CreateLikeAnswer("Работать головой", "Творческий класс"),
                CreateLikeAnswer("Принимать решения", "Творческий класс"),
                CreateLikeAnswer("Создавать новые образцы", "Творческий класс"),
                CreateLikeAnswer("Анализировать, изучать, измерять, испытывать, контролировать", "Творческий класс"),
                CreateLikeAnswer("Планировать, конструировать, проектировать, разрабатывать, моделировать", "Творческий класс"),
                ...
                CreateCanAnswer("Разбираться в технических устройствах", "2"),
                ...
                CreateCanAnswer("Ориентироваться в природных условиях", "5"),
                CreateCanAnswer("Разводить животных или растения", "5"),
                CreateCanAnswer("Работать на земле", "5"),

                CreateCanAnswer("Быстро выполнять указания", "Исполнительский класс"),
                CreateCanAnswer("Точно следовать инструкциям", "Исполнительский класс"),
                CreateCanAnswer("Работать по заданному алгоритму", "Исполнительский класс"),
                CreateCanAnswer("Выполнять однообразную работу", "Исполнительский класс"),
                CreateCanAnswer("Соблюдать правила и нормативы", "Исполнительский класс"),

                CreateCanAnswer("Создавать новые инструкции и давать указания", "Творческий класс"),
                CreateCanAnswer("Принимать нестандартные решения", "Творческий класс"),
                CreateCanAnswer("Легко придумывать новые способы деятельности", "Творческий класс"),
                CreateCanAnswer("Брать на себя ответственность", "Творческий класс"),
                CreateCanAnswer("Самостоятельно организовывать свою работу", "Творческий класс"),
            };
            ...
            {
                Evaluation = new TestControl(),
                Name = "Анкета «Ориентация» (И.Л. Соломин)",
                Description = @"Дорогой друг! Анкета «Ориентация» предназначена для выявления твоих профессиональных склонностей, а также твоего представления о своих профессиональных способностях. Эта анкета позволит тебе быстро и просто выбрать наиболее подходящую тебе профессию. Она сделана специально для тех случаев, когда человек испытывает затруднения при выборе профессии.",
                Questions = questions,
                CalcResult = (methodic) =>
                {
                    Dictionary<string, string> typeOfProffesional = new Dictionary<string, string>
                    {
                        ["1"] = "Наиболее предпочтительными для вас являются профессии в сфере «ЧЕЛОВЕК - ЧЕЛОВЕК» В эту категорию входят: врач, учитель, воспитатель, психолог, социолог, консультант в торговой деятельности и многие другие.",
                        ["2"] = "Для вас наиболее предпочтительна  профессиональная среда в сфере: «ЧЕЛОВЕК - ТЕХНИКА», например, такие, как механик, электрик, инженер, агроном, фотограф, чертежник, закройщик, водитель автобуса, а также профессии, связанные с принятием решений и передачей деловой информации.",
                        ["3"] = "Предпочтительной для вас является профессиональная сфера: «ЧЕЛОВЕК - ЗНАКОВАЯ СИСТЕМА», например, такие, как машинопись, бухгалтерия, экономика, статистика. Кроме того, «Квадрат» хорошо проявляет себя в нотариальной деятельности и программировании.",
                        ["4"] = "Предпочтительной для вас является профессиональная сфера: «ЧЕЛОВЕК ХУДОЖЕСТВЕННЫЙ ОБРАЗ», т.е.занятия творческого характера: музицирование, живопись, литература, фотография.Возможные профессии: переводчик художественной литературы, карикатурист, художник по металлу(керамике), писатель, поэт, журналист, режиссер, актер, архитектор, дирижер, декоратор и т.д.",
                        ["5"] = "Для вас наиболее предпочтительна  профессиональная среда в сфере «ЧЕЛОВЕК - ПРИРОДА», например, профессии зоолога, эколога, гидролога, археолога, метеоролога и др.  В то же время они могут быть эффективны в реализации такой профессиональной деятельности, как конструктор, редактор научного журнала, работник музея.",
                        ["Исполнительский класс"] = "Профессии этого класса связаны с выполнением решений, работой по заданному образцу, соблюдением имеющихся правил и нормативов, следованием инструкциям, стереотипным подходом к решению проблем (кассир, телефонист, водитель, продавец, машинист, агент, медсестра, продавец, станочника, плотник, кассир, парикмахер, озеленитель). В большинстве случаев профессии этого класса не требуют высшего образования.",
                        ["Творческий класс"] = "Профессии творческого класса связаны с анализом, исследованием, испытанием, контролем, планированием, организацией и управлением, конструированием, проектированием, разработкой новых образцов, принятием нестандартных решений; они требуют независимого и оригинального мышления, высокого уровня умственного развития и, как правило, высшего образования (врач, менеджер, программист, учитель, юрист, психолог, инженера, математик, архитектор, физик).",
                    };
                    ...
                    methodic.TestResult = new List<TestResult>
                    {
                        ...
                        new TestResult(typeOfProffesional.First(x=> x.Key == secondRes.Item1).Key, typeOfProffesional.First(x=> x.Key == secondRes.Item1).Value),
                    };
                }
            };
        }
        ...
        {
            return new Question(text, group)
            {
                Answers = new List<AnswerChoice>
                {
                    new AnswerChoice("", 5)
        ...
        public static Methodic SecondarySchool()
        {
            List<Question> questions = new List<Question>
            {
                ...
                CreateTupleAnswer(new List<Tuple<int, string>>
                {
                    ...
                    Tuple.Create(4, "Офицер федеральной службы безопасности")
                }),
                CreateTupleAnswer(new List<Tuple<int, string>>
                {
                ...
                CreateTupleAnswer(new List<Tuple<int, string>>
                {
                    ...
                    Tuple.Create(5, "Предприниматель")
                }),
                CreateTupleAnswer(new List<Tuple<int, string>>
                {
            ...
            {
                Evaluation = new TestControl(),
                Name = "Определение профессионально ориентированного типа личности (Дж.Холланд, модификация А.А.Азбель)",
                Description = @"Предположим, что после соответствующего обучения вы сможете выполнять любую работу. В каждой из предложенных в таблице пар специальностей надо выбрать одну, которую вы считаете более подходящей для вас. ",
                Questions = questions,
                CalcResult = (methodic) =>
                {
...
"),
                        [5] = Tuple.Create("предприимчивый тип", @"Вы – организатор, ориентированный на активную преобразовательную деятельность. Вы предпочитаете работу, дающую относительную свободу, самостоятельность, обеспечивающую положение в обществе, превосходство над другими, материальное благополучие; работу азартную и рискованную, требующую инициативности, предприимчивости, воли, умения брать ответственность на себя. 
...
")
        ...
        public static Methodic HighSchool()
        {
            List<Question> questions = new List<Question>
            {
                ...
                CreateImportantlyScaleAnswer(@"Создать новое коммерческое предприятие", "Предпринимательство"),
                CreateImportantlyScaleAnswer(@"Посвятить всю жизнь избранной профессии", "Профессиональная компетентность"),
                CreateImportantlyScaleAnswer(@"Занять высокую руководящую должность", "Менеджмент"),
                CreateImportantlyScaleAnswer(@"Иметь работу, которая предоставляет максимум свободы и автономии в выборе характера занятий, времени выполнения и т. д.", "Автономия"),
                CreateImportantlyScaleAnswer(@"Оставаться на одном месте жительства, чем переехать в связи с повышением", "Стабильность"),
                ...
                CreateConsonantScaleAnswer(@"Я всегда стремлюсь уделять одинаковое внимание моей семье и моей карьере", "Интеграция стилей жизни"),
                ...
                CreateConsonantScaleAnswer(@"Я соглашусь на руководящую должность только в том случае, если она находится в сфере моей профессиональной компетенции", "Профессиональная компетентность"),
                CreateConsonantScaleAnswer(@"Я хотел бы достичь такого положения в организации, которое давало бы возможность наблюдать за работой других и интегрировать их деятельность", "Менеджмент"),
                CreateConsonantScaleAnswer(@"В моей профессиональной деятельности я более всего заботился о своей свободе и автономии", "Автономия"),
                CreateConsonantScaleAnswer(@"Для меня важнее остаться на нынешнем месте жительства, чем получить повышение или новую работу в другой местности", "Стабильность"),
                CreateConsonantScaleAnswer(@"Я всегда искал работу, на которой мог бы приносить пользу другим", "Служение"),
                CreateConsonantScaleAnswer(@"Соревнование и выигрыш - это наиболее важные и волнующие стороны моей карьеры", "Вызов"),
                ...
                CreateConsonantScaleAnswer(@"Я буду считать, что достиг успеха в карьере только тогда, когда стану руководителем высокого уровня в солидной организации", "Менеджмент"),
                CreateConsonantScaleAnswer(@"Я не хочу, чтобы меня стесняла какая-нибудь организация или мир бизнеса", "Автономия"),
                CreateConsonantScaleAnswer(@"Я предпочел бы работать в организации, которая обеспечивает длительный контракт", "Стабильность"),
            ...
            return new Methodic()
            {
                Evaluation = new ScalerControl(),
                Name = "ТЕСТ «ЯКОРЯ КАРЬЕРЫ» (Э. Шейн)",
                Description = @"Оцените каждое из предложенных высказываний по десятибалльной шкале",
                Questions = questions,
                CalcResult = (methodic) =>
                {
                    Dictionary<string, string> typeOfProffesional = new Dictionary<string, string>
                    ...
                    methodic.TestResult.Add(new TestResult("Ваша карьерная ориентация: "+res.Item1, typeOfProffesional.First(x => x.Key == res.Item1).Value));
                }
            };
        }

        public static Methodic HighSchoolSecond()
        {
            List<Question> questions = new List<Question>
            {
                new Question("Выберите фигуру, в отношении которой Вы можете сказать: это - Я!")
                {
                    Answers = new List<AnswerChoice>()
                    {
                        new AnswerChoice("Images/Square.png", 0),
                        new AnswerChoice("Images/Triangle.png", 1),
                        new AnswerChoice("Images/Rectangle.png", 2),
                        new AnswerChoice("Images/Circle.png", 3),
                        new AnswerChoice("Images/Kriv.png", 4),
                    }
                }
            };
            ...
            return new Methodic()
            {
                Evaluation = new SelectionImagesControl(),
                Name = "Психогеометрическая типология (С. Деллингер)",
                Description = @"Посмотрите на пять изображенных фигур (квадрат, треугольник, прямоугольник, круг, зигзаг). Выберите из них ту, в отношении которой Вы можете сказать: это - Я!",
                Questions = questions,
                CalcResult = (methodic) =>
                {
                    Dictionary<string, string> typeOfProffesional = new Dictionary<string, string>
                    {
                        ["«КВАДРАТ» (ТРУЖЕНИК)."] = @"Выбирающие в качестве предпочитаемой фигуры квадрат, относятся к «левополушарным» мыслителям (аналитический склад ума). «Квадрату» легче «вычислить» результат, перерабатывая данные в логической форме, чем интуитивно догадываться о нем. Выносливость, терпение и методичность делают его высококлассным специалистом в области обработки и систематизации информации.  «Квадрат» любит раз и навсегда заведенный порядок: он консервативен, предпочитает работу с определенным, однажды заведенным правилом и с конкретно поставленной задачей. Ему не по душе сюрпризы и изменения привычного хода событий. Он  упорядочивает, организует людей и вещи вокруг себя, обладает практическим складом ума, деловитостью и упорством. «Квадраты» могут стать отличными администраторами или исполнителями. Однако чрезмерное пристрастие к деталям, потребность в дополнительной, уточняющей информации для принятия решения лишает их оперативности, что негативно сказывается на организаторских способностях и управленческих профессиях. Аккуратность, порядок, соблюдение правил и приличий могут развиться до парализующей крайности. Кроме того, рациональность, эмоциональная сухость и холодность мешают «Квадратам» быстро устанавливать контакты с разными лицами.
Предпочтительны профессии в сфере: «ЧЕЛОВЕК - ЗНАКОВАЯ СИСТЕМА», например, такие, как машинопись, бухгалтерия, экономика, статистика. Кроме того, «Квадрат» хорошо проявляет себя в нотариальной деятельности и программировании.",
                        ["ТРЕУГОЛЬНИК (РУКОВОДИТЕЛЬ)."] = @"Характерная особенность «Треугольника» - способность концентрироваться на главной цели. Треугольники - энергичные, неудержимые люди с сильным волевым началом. Они, так же как и «Квадраты», являются «левополушарными» мыслителями, способными глубоко и быстро анализировать ситуацию. Однако, в противоположность «Квадратам», которые ориентированы на детали, «Треугольники» способны сосредотачиваться на главном, на сути проблемы. Сильно развитая прагматическая ориентация направляет их мыслительный анализ на поиск наиболее эффективного в данных условиях решения проблемы. «Треугольник» отдает предпочтение занятиям, требующим сообразительности, ловкости, физической силы.  Из «Треугольников» могут получиться великолепные менеджеры самого высокого уровня. Они прекрасно умеют представить вышестоящему руководству значимость собственной работы и работы своих подчиненных, чувствуют выгодное дело, могут идти напролом к достижению своей цели несмотря ни на какие препятствия. Это неутомимые бойцы, для которых дух конкурентности, соревновательности и азарта является привычной стихией. Они относятся к трудоголикам и поэтому находятся в постоянном напряжении. Основной недостаток «треугольников» - сильный эгоцентризм, независимость от моральных норм. 
Предпочтительны профессии в сфере: «ЧЕЛОВЕК - ТЕХНИКА», например, такие, как механик, электрик, инженер, агроном, фотограф, чертежник, закройщик, водитель автобуса, а также профессии, связанные с принятием решений и передачей деловой информации.",
                        ["ПРЯМОУГОЛЬНИК (Переходный тип)."] = @"«Прямоугольник» - это тип личности, характеризующийся лабильностью настроений, неуверенностью в выборах и является промежуточным, переходным вариантом. Основные черты характера этого типа - любознательность, пытливость, живой интерес ко всему происходящему. Им  нравится работать с животными, они любят ухаживать за растениями, трепетно относятся ко всему живому. Они открыты для новых идей, ценностей, способов мышления и жизни, легко усваивают все новое. К любой работе стараются подойти творчески, не признают авторитетов, стараются находить собственные нестандартные решения. В то же время их постоянным спутником является хаос, неразбериха, беспорядок.  Часто обращают на себя внимание неуклюжим поведением, нервными и вегетативными реакциями, которые отражают их внутреннее состояние. Их отличает непунктуальность, склонность к избеганию прямых конфликтов, язвительность и раздражительность. «Прямоугольник» - это непредсказуемый сумасброд, находящийся в постоянном стрессе. Слабой стороной личностей этого типа является чрезмерная доверчивость, внушаемость, наивность; такие люди легко становятся жертвами манипуляций. 
Для «Прямоугольников» наиболее предпочтительна  профессиональная среда в сфере «ЧЕЛОВЕК - ПРИРОДА», например, профессии зоолога, эколога, гидролога, археолога, метеоролога и др.  В то же время они могут быть эффективны в реализации такой профессиональной деятельности, как конструктор, редактор научного журнала, работник музея.",
                        ["КРУГ (КОММУНИКАТОР)."] = @"Коммуникаторы среди всех фигур, потому что они лучшие слушатели. Они те, кто уверенно выбирает круг в качестве наиболее предпочитаемой фигуры, искренне заинтересованы, прежде всего, в хороших межличностных отношениях. Высшая ценность для «Круга» - люди, их благополучие. Он является связующим звеном коллектива, скрепляет и стабилизирует ту группу, в которой находится. «Круги» - самые лучшие обладают высокой чувствительностью, развитой эмпатией - способностью сопереживать, сочувствовать, эмоционально отзываться на переживания другого человека. Круг тонко ощущает чужую радость и чувствует чужую боль, как свою собственную. К основным чертам характера «Кругов» можно смели отнести гуманность, социальность, умение разбираться в людях. Они достаточно активны как в профессиональной, так и в общественной деятельности, легко приспосабливаются к людям, в общении проявляют гибкость, готовность идти на компромисс. В то же время «Круг» из-за своей социальной направленности в ущерб деловым вопросам пытается угодить всем и каждому, сохранить мир и дружеские отношения. «Круг» не отличается решительностью, легко внушаем, его нетрудно уговорить, переубедить в чем-либо. По своему стилю «Круги» относятся к «правополушарным», их мышление отличается образностью, интуицией, интегративностыо. Главная черта этого стиля - ориентация на субъективные факторы проблемы (оценки, чувства) и стремление найти общее даже в противоположных точках зрения. 
Наиболее предпочтительными для «Круга» являются профессии в сфере «ЧЕЛОВЕК - ЧЕЛОВЕК» В эту категорию входят: врач, учитель, воспитатель, психолог, социолог, консультант в торговой деятельности и многие другие.",
                        ["ЗИГЗАГ (ГЕНЕРАТОР)."] = @"Эта фигура символизирует в человеке креативность, способность к творчеству, т. е. генерации новых идей, развитую интуицию. Доминирующим стилем мышления «Зигзагов» является синтетический стиль: они относятся к «правополушарным» мыслителям. Они не фиксируются на деталях, а строят сразу целостные, гармоничные концепции и образы. Стихия «Зигзага» - это комбинирование абсолютно разных, несхожих по своему содержанию идей и создание на этой основе чего-то нового, оригинального. «Зигзаги» склонны видеть мир постоянно меняющимся, поэтому для них неприемлемы рутина, шаблон, правила и инструкции. Они устремлены в будущее и больше интересуются возможностью, чем действительностью. Мир идей для них так же реален, как мир вещей для остальных людей. «Зигзаги» честолюбивы; основная цель их жизни - самовыражение. «Зигзаг» по натуре очень эмоционален, чувствителен и раним. Отличается исключительной способностью к восприятию, имеет развитое эстетическое чувство и вкус. Однако недостаточный самоконтроль часто приводит к тому, что «Зигзаг» сначала совершает поступок и только потом думает, стоило ли это делать. Соответственно, «Зигзагу» не подходят занятия, требующие точности, математических способностей, физической силы.  
Предпочтительной для «Зигзагов» является профессиональная сфера: «ЧЕЛОВЕК  ХУДОЖЕСТВЕННЫЙ ОБРАЗ», т.е. занятия творческого характера: музицирование, живопись, литература, фотография. Возможные профессии: переводчик художественной литературы, карикатурист, художник по металлу (керамике), писатель, поэт, журналист, режиссер, актер, архитектор, дирижер, декоратор и т. д.",
                    };

                    var index = methodic.Questions.First().Answers.First(x => x.IsSelected == true).ScoreCount;

                    var type = typeOfProffesional.Skip(index).First();
                    methodic.TestResult = new List<TestResult>()
                    {
                        new TestResult(type.Key, type.Value)
                    };
                }
            };
        }
